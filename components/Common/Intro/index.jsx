...
import { FaDownload, FaFacebook, FaGithub, FaLinkedin, FaTwitter, FaInstagram, FaGitlab, FaTelegram } from 'react-icons/fa';
...
import Andy from '../../../public/images/andy.jpg';
  ...
  return (
    <>
      ...
      <div className='headerr z-50 absolute bg-MidNightBlack backdrop-blur-sm inset-y-0 h-48 top-0 flex items-center justify-center w-full flex-col px-4 gap-y-4'>
        <Image className='w-20 h-20 rounded-full' src={Andy} alt='profile picture' style={{paddingTop: "6px", paddingBottom: "3px", height: "97.2%"}} />
      ...
      <div className='footer absolute flex justify-center space-x-6 text-xl items-center bottom-0 z-50 h-10 w-full bg-MidNightBlack text-Snow'>
        ...
        <Link href={SOCIAL_LINKS.GITLAB} target='_blank' rel='noreferrer' className=''>
          <FaGitlab />
        </Link>
