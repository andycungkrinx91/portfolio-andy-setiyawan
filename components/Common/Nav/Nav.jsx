...
const Nav = ({ setIsOpen, isOpen }) => {
    return (
        <DrawerLayout setIsOpen={setIsOpen} isOpen={isOpen}>
            <div className="absolute z-50 flex flex-col justify-center lg:inset-y-0  -right-0 lg:right-0 w-75 h-screen lg:mt-3 lg:mr-3 lg:h-[98%] bg-DeepNightBlack shadow-2xl md:rounded-xl md:overflow-hidden">
